...
public class DbcpUtil {
    ...
    private static void init() throws Exception {
        ...
        try {
            ...
            LOG.warn("completed datasource" + !DbcpUtil.dataSource.isClosed());
        } catch (Exception e) {
            throw new Exception("fail creating datasource: " + e.getMessage(), e.getCause());
        }
    }
    ...
    /**
     * close resultset and satatement
     */
    ...
    public static DBConnectionResource executeQuery(String querySql) throws Exception {
        try {
            ...
            throw new Exception("execute sql [" + querySql + "] occur an error " + e.getMessage(), e.getCause());
        }
    }
