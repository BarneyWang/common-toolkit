...
import me.toolkit.java.constant.BaseConstant;
import me.toolkit.java.constant.EmptyObjectConstant;
import me.toolkit.java.constant.SymbolConstant;
import me.toolkit.java.exception.NotExpectedFormatedException;
...
import static me.toolkit.java.constant.EmptyObjectConstant.EMPTY_STRING_ARRAY;
...
public class StringUtilTest {
	...
	public static String NILEADER_MAIL_STR 	  = "wangdi0410@gmail.com";
	public static String NILEADER_STR      	  = "wangdi0410";
	...
	public void containsIgnoreCase() {
		...
		String targetStr = "wangdi0410";
		String targetStr2 = "wangdi0410";
		String targetStr3 = "wangdi5";
	...
	public void equalsIgnoreCaseAll() {
		...
		String[] compareStrArray = { "wangdi0410", "wangdi0410", "wangdi0410" };
		String[] compareStrArray2 = { "wangdi0410", "wangdi0410", "wangdi0410", "yinshi.nc" };

		assertTrue( StringUtil.equalsIgnoreCaseAll( "wangdi0410", compareStrArray ) );
		assertFalse( StringUtil.equalsIgnoreCaseAll( "wangdi0410", compareStrArray2 ) );
	}
	...
	public void equalsIgnoreCaseOne() {
		...
		assertTrue( StringUtil.equalsIgnoreCaseOne( "wangdi0410", compareStrArray ) );
		assertTrue( StringUtil.equalsIgnoreCaseOne( "wangdi0410", compareStrArray2 ) );
		assertFalse( StringUtil.equalsIgnoreCaseOne( "wangdi0410", compareStrArray3 ) );
	}

	@Test
	public void findAllByRegex() {
		String originalStr = "My name is name:wangdi0410-dev1, you can call me name:wangdi0410-dev2,";
		List< String > targetList = new ArrayList< String >();
		targetList.add( "name:wangdi0410-dev1," );
		targetList.add( "name:wangdi0410-dev2," );
	...
	public void isContainWhitespace() {
		...
		assertTrue( StringUtil.isContainWhitespace( " wangdi0410" ) );
		assertTrue( StringUtil.isContainWhitespace( "ni leader" ) );
		assertTrue( StringUtil.isContainWhitespace( "wangdi0410 " ) );
		assertFalse( StringUtil.isContainWhitespace( "wangdi0410" ) );
	}
	
	@Test
	public void join() {
		String str1 = "wangdi0410";
		String str2 = "";
		String str3 = "中文";
	...
	public void testMakeFirstLetterLowerCase() {
		assertEquals( "wangdi0410", StringUtil.makeFirstLetterLowerCase( "wangdi0410" ) );
	}
	...
	public void replaceAll() {
		...
		String originalStr = "My name is wangdi0410, i came form China, wangdi0410 is my network id.";
		...
		assertEquals( "abc name is wangdi0410, i came form China, wangdi0410 is my network id.", StringUtil.replaceAll( originalStr, replacement, "My" ) );
	...
	public void replaceLast() {
		...
		assertEquals( "My name is wangdi0410, i came form China, abc is my network id.",
				StringUtil.replaceLast( originalStr, NILEADER_STR, replacement ) );
		assertEquals( "abc name is wangdi0410, i came form China, wangdi0410 is my network id.", StringUtil.replaceLast( originalStr, "My", replacement ) );
	...
	public void trimToEmpty() {
		...
		String originalStr = " wangdi0410 wangdi0410 ";
		assertEquals( "wangdi0410 wangdi0410", StringUtil.trimToEmpty( originalStr ) );
	}
}
