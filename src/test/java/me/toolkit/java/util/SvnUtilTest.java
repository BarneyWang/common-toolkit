...
public class SvnUtilTest {
    ...
    public void testParseFileProjectPathFromSvnPath() {
        ...
        String svnPath = "http://svn2.letv.net/repos/plugins/trunk/reviewboardtest/pagecache-webx3-ga-example/pagecache-webx3-ga-example-web/src/main/java/com/alibaba/webx/pagecache/app1/module/screen/Cached.java";
        ...
        try {
            SvnUtil.parseFileProjectPathFromSvnPath("wangdi0410");
