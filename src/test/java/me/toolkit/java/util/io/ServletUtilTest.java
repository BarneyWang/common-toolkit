...
import me.toolkit.java.constant.HttpConstant;
import me.toolkit.java.constant.SymbolConstant;
import me.toolkit.java.exception.CanNotEncodeException;
import me.toolkit.java.exception.IllegalParamException;
import me.toolkit.java.util.ObjectUtil;
...
public class ServletUtilTest {
	...
	private static String DEFAULT_SERVER_NAME = "ops.jm.letv.net";
	private static String DEFAULT_DOMAIN = ".jm.letv.net";

	private static String DEFAULT_REQUEST_URI = "/common/test.do";
	private static String DEFAULT_REQUEST_CONTEXT_PATH = "/common";

	private static String DEFAULT_REQUEST_QUERYSTRING = "method=test" + SymbolConstant.AND_SIGN + "userName=wangdi5" + SymbolConstant.AND_SIGN
			+ "displayName=王迪" + SymbolConstant.AND_SIGN + "staffNo=41521";
	...
	public void encodeParamsForRequestURL() throws UnsupportedEncodingException {
		...
		String originalRequestURL_WITH_PARAMS_1 = "http://ops.jm.letv.net:9999/taokeeper/index.do?method=test&userName=王迪&passowrd=*#K=4@T6gW";
		String expectedEncodedRequestURL_GBK_1 = "http://ops.jm.letv.net:9999/taokeeper/index.do?method="
				+ java.net.URLEncoder.encode( "test", "GBK" ) + "&userName=" + java.net.URLEncoder.encode( "王迪", "GBK" ) + "&passowrd="
				+ java.net.URLEncoder.encode( "*#K=4@T6gW", "GBK" );
		String expectedEncodedRequestURL_ISO8859_1 = "http://ops.jm.letv.net:9999/taokeeper/index.do?method="
				+ java.net.URLEncoder.encode( "test", "ISO8859-1" ) + "&userName=" + java.net.URLEncoder.encode( "王迪", "ISO8859-1" ) + "&passowrd="
				+ java.net.URLEncoder.encode( "*#K=4@T6gW", "ISO8859-1" );
		String expectedEncodedRequestURL_UTF8_1 = "http://ops.jm.letv.net:9999/taokeeper/index.do?method="
				+ java.net.URLEncoder.encode( "test", "UTF-8" ) + "&userName=" + java.net.URLEncoder.encode( "王迪", "UTF-8" ) + "&passowrd="
				+ java.net.URLEncoder.encode( "*#K=4@T6gW", "UTF-8" );

		String originalRequestURL_WITH_PARAMS_2 = "http://ops.jm.letv.net:9999/taokeeper/index.do?method=test&userName=银时&passowrd=*#K4@T6gW";
		String expectedEncodedRequestURL_GBK_2 = "http://ops.jm.letv.net:9999/taokeeper/index.do?method="
				+ java.net.URLEncoder.encode( "test", "GBK" ) + "&userName=" + java.net.URLEncoder.encode( "王迪", "GBK" ) + "&passowrd="
				+ java.net.URLEncoder.encode( "*#K4@T6gW", "GBK" );
		String expectedEncodedRequestURL_ISO8859_2 = "http://ops.jm.letv.net:9999/taokeeper/index.do?method="
				+ java.net.URLEncoder.encode( "test", "ISO8859-1" ) + "&userName=" + java.net.URLEncoder.encode( "王迪", "ISO8859-1" ) + "&passowrd="
				+ java.net.URLEncoder.encode( "*#K4@T6gW", "ISO8859-1" );

		// 以下4个应该原样返回
		String originalRequestURL_WITH_PARAMS_3 = "http://ops.jm.letv.net:9999/taokeeper/index.do";
		String originalRequestURL_WITH_PARAMS_4 = "http://ops.jm.letv.net:9999/taokeeper/index.do?";
		String originalRequestURL_WITH_PARAMS_5 = "http://ops.jm.letv.net:9999/taokeeper/index.do?method=";
		...
		try {
			assertEquals( expectedEncodedRequestURL_ISO8859_2, ServletUtil.encodeParamsForRequestURL( originalRequestURL_WITH_PARAMS_2, "WANGDI.NC" ) );
			fail( "不应该执行我" );
		} catch ( CanNotEncodeException e ) {
		} catch ( Exception e ) {
			fail( "不应该执行我" );
	...
	public void getDomain() throws IllegalParamException {
		...
		assertEquals( expectedDomain, ServletUtil.getDomainFromRequestURL( "https://ops.jm.letv.net/taokeeper-monitor/test.do" ) );
	...
	private void setParameter() {
		...
		request.setParameter( "userName", "wangdi5" );
		request.setParameter( "displayName", "wangdi" );
